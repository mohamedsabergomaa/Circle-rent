        ...
        <div className="space-y-4">
          ...
          <div className="rounded-3xl border border-line bg-[#faf8fb] p-6 sm:p-7">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 rounded-full bg-brand px-5 py-2.5 text-sm font-bold text-cream hover:bg-[#4a2650] transition-colors"
              >
                تواصل معنا
                <ArrowLeft size={15} />
              </Link>
