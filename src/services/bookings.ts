...
export async function createBooking(input: CreateBookingInput): Promise<MockBooking> {
  return api<MockBooking>('/bookings', { method: 'POST', body: JSON.stringify(input) })
}

export async function updateBookingStatus(id: string, status: BookingStatus): Promise<MockBooking> {
...
export async function submitReturn(id: string, notes: string, photo?: File): Promise<void> {
