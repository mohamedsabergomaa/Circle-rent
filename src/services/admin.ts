...
export type AdminListUsersParams = { page?: number; limit?: number; search?: string; status?: string }
export type AdminListListingsParams = { page?: number; limit?: number; search?: string; status?: string }
export type AdminListBookingsParams = { page?: number; limit?: number; search?: string; status?: string }
export type AdminListReportsParams = { page?: number; limit?: number; status?: string }

export type PaginatedResult<T> = { items: T[]; total: number; page: number; pages: number }

export function getAdminStats(): Promise<AdminStats> {
  return api<AdminStats>('/admin/stats')
}

export function listAdminUsers(params: AdminListUsersParams = {}): Promise<PaginatedResult<AdminUser>> {
...
export function listAdminListings(params: AdminListListingsParams = {}): Promise<PaginatedResult<AdminListing>> {
  const q = new URLSearchParams(params as Record<string, string>)
...
export function listAdminBookings(params: AdminListBookingsParams = {}): Promise<PaginatedResult<AdminBooking>> {
  const q = new URLSearchParams(params as Record<string, string>)
  return api<PaginatedResult<AdminBooking>>(`/admin/bookings?${q}`)
}

export function listAdminReports(params: AdminListReportsParams = {}): Promise<PaginatedResult<AdminReport>> {
  const q = new URLSearchParams(params as Record<string, string>)
